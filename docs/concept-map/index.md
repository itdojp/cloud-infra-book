...
![クラウドインフラ設計・構築ガイドの概念マップ。責任共有を起点に、identity、network、compute、storage、運用、可用性とDR、cost、IaCとautomationを各章へ接続する](../assets/images/diagrams/introduction/cloud-infra-mindmap.svg)
...
- [付録：参考資料](../appendices/index.md): 設計checklist、用語、provider比較、一次情報への導線を確認する。
